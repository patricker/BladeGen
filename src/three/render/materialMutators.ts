...
function getPartRoots(
  sword: SwordGenerator,
  part: SwordPart
): Array<THREE.Object3D | null | undefined> {
...
export function visitPartMaterials(
  sword: SwordGenerator,
  part: SwordPart,
  visitor: MaterialVisitor
) {
...
export function setHighlight(
  ...
  visitPartMaterials(sword, part, (material) =>
    applyHighlightState(material, true, color, intensity)
  );
}
