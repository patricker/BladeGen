```json
{
  "id": "render-mode.render-mode",
  "label": "Render Mode",
  "summary": "Switch between Standard and Pixel Art output modes.",
  "details": [
    "Pixel Art snaps the final image to a coarse pixel grid for a retro look.",
