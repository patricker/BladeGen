...
const {
  Vector2Stub,
  WebGLRenderTargetStub,
  WebGLMultisampleRenderTargetStub,
  ColorProxy
} = vi.hoisted(() => {
  ...
  class WebGLRenderTargetStubInner {
    texture: { name?: string }
    samples = 0
    constructor(public width = 1, public height = 1, opts: any = {}) {
  ...
  class ColorProxyInner {
    ...
    set(v: string | number) { this.value = v; return this }
    setHex(v: number) { this.value = v; return this }
  }
