...
import { setPartBump, setPartClearcoat, setPartClearcoatRoughness, setPartColor, setPartMetalness, setPartRoughness, visitPartMaterials } from '../render/materialMutators'
...
describe('material mutators', () => {
  ...
  it('applies and clears bump noise textures per part', () => {
    const noiseTexture = new THREE.DataTexture(new Uint8Array([255, 255, 255, 255]), 1, 1, THREE.RGBAFormat)
