...
describe('guardDecor', () => {
  ...
  it('adds langets when enabled', () => {
    ...
    const langetMeshes = guardGroup.children.filter((child) => child instanceof THREE.Mesh && (child as THREE.Mesh).geometry instanceof THREE.BoxGeometry)
  ...
  it('adds pas d\'âne rings based on count', () => {
    ...
    const ringMeshes = guardGroup.children.filter((child) => child instanceof THREE.Mesh && (child as THREE.Mesh).geometry instanceof THREE.TorusGeometry)
