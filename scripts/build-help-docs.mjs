...
function readExistingDocsJSON() {
  try { const raw = readFileSync(jsonTarget, 'utf8'); return JSON.parse(raw) } catch { return [] }
}
...
try {
  ...
  console.log(`[help-docs] Merged ${incoming.length} MD docs into ${merged.length} JSON docs -> ${jsonTarget}`)
} catch (err) {
